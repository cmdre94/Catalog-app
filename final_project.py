...
from item_database_setup import Base, Category, Item, User
...
def deleteCategory(category_id):
    ...
    if categoryToDelete.user_id != login_session['user_id']:
        ...
        category in order to delete.');}</script><body onload='myFunction()''>"
    if request.method == 'POST':
...
def newItem(category_id):
    ...
    if login_session['user_id'] != category.user_id:
        return "<script>function myFunction() {alert('You are not authorized \
        to add items to this category. Please create your own category in \
...
def editItem(category_id, item_id):
    ...
    if login_session['user_id'] != category.user_id:
        return "<script>function myFunction() {alert('You are not authorized \
        to edit items to this category. Please create your own category in \
